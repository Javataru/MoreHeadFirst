...
public class BeatBox {
	...
	Track track;
	JFrame mainFrame;
	String[] instrumentNames = {"Bass Drum", "Closed Hi-Hat", "Open Hi-Hat", "Acoustic Snare", "Crash Cymbal", "Hand Clap", "High Tom", "Hi Bongo", "Maracas", "Whistle", "Low Conga", "More Cowbell", "Vibraslap", "Low-mid Tom", "High Agogo", "Open High Conga" };
	...
	public void buildGUI(){
		...
		JButton start = new JButton("Engage");
		start.addActionListener(new MyStartListener());
		buttonBox.add(start);
		
		JButton stop = new JButton("Desist");
